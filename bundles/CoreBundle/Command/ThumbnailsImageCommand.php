...
class ThumbnailsImageCommand extends AbstractCommand
{
    ...
    protected function configure()
    {
        ...
        $this
            ...
            ->addOption(
                ...
                null,
                InputOption::VALUE_OPTIONAL,
                'only create thumbnails of images with with filenames starting with (filenamePrefix)'
            )
            ->addOption(
                'filenameSuffix',
                null,
                InputOption::VALUE_OPTIONAL,
                'only create thumbnails of images with with filenames ending with (filenameSuffix)'
            )
            ->addOption(
                'thumbnails',
                't',
    ...
    protected function fetchItems(InputInterface $input): array
    {
        ...
        if ($filenamePrefix = $input->getOption('filenameSuffix')) {
            $conditions[] = '`filename` LIKE ?';
            $conditionVariables[] = '%' . $filenamePrefix;
        }
